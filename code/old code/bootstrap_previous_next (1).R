...
result_files <- list.files(path = './data/bootstrap_results/')


for(ii in 1:length(result_files)) {
	xdata <- read_delim(file = paste0('./data/bootstrap_results/', result_files[ii]),
	...
	write_csv(xdata, paste0("./data/", new_filename))
